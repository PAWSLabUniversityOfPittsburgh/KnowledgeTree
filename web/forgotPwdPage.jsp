...
<form id="resetform" method="post">
	<table border="0" cellspacing="0" cellpadding="4" align="center" width="450px" style=" padding:5px; background-color:#D7E8FE; border:1px dotted #000099">
        ...
        <tr>
    	  <td colspan="2" style="color:red; text-align:justify; font-size:14px">Please input your e-mail address. Then there will be a link sent to your e-mail for you to reset your password.
    	  <br><br>If you have any question, please contact mallium@gmail.com</td>
    	</tr>
